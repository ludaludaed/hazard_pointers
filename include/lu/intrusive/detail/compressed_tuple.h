...
public:
  ...
  template<class... _Us, class = std::enable_if_t<std::conjunction_v<
                                 std::bool_constant<sizeof...(Ts) == sizeof...(_Us)>, std::is_constructible<Ts, _Us>...,
                                 std::negation<is_this_tuple<_Us...>>>>>
  constexpr explicit(std::negation_v<std::conjunction<std::is_convertible<_Us, Ts>...>>) compressed_tuple(_Us &&...args)
